<nav id="header" class="bg-red-500 fixed w-full z-10 top-0 shadow">
      ...
      <a href="#" class="flex items-center py-4 px-2">
                ...
                <a class="mt-10 text-gray-100 text-base xl:text-xl no-underline hover:no-underline font-bold"  href="#">Panell d'administrador</a>
         </div>
			...
			<div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-red-500 z-20" id="nav-content">
				<ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-50 no-underline hover:text-gray-100 border-gray-50  hover:text-purple-400 hover:scale-105">
                            <i class="fa fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Articles</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-50 no-underline hover:text-gray-100  border-gray-50  hover:border-green-200">
