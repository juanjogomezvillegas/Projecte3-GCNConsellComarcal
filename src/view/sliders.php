                                ...
                                <?php foreach ($dadesliders as $actual) { ?>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-600">
                                        ...
                                        <td class="text-sm text-gray-500 px-6 py-4 whitespace-nowrap dark:text-gray-400">
                                            ...
                                            <input value="<?= $actual['posicio']; ?>" class="text-center h-8 px-1 text-sm text-gray-700 placeholder-gray-600 border rounded-lg focus:shadow-outline w-10" type="text" placeholder="Small input"/>
                                        </td>
