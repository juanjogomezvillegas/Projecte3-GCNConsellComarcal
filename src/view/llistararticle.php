...
<head>
    ...
    <title>Gestió d'Articles | GCN Consell Comarcal</title>
</head>
                                ...
                                <?php foreach ($dadesarticle as $actual) { ?>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-600">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <?php if ($dadesUsuariLogat["rol"] === "Administrador") { ?>
                                                <a href="index.php?r=historialArticleConcret&id=<?php echo $actual['id']; ?>" class="text-pink-600 hover:text-pink-900 dark:text-pink-500 dark:hover:underline"><i class="fas fa-history"></i></a>
                                            <?php } ?>
                                            <a href="index.php?r=actualitzararticle&id=<?php echo $actual['id']; ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-500 dark:hover:underline"><i class="fas fa-edit"></i></a>
...
<div id="modalConfirmacio" class="hidden flex items-center justify-center fixed left-0 bottom-0 fixed z-10 inset-0 overflow-y-auto bg-gray-500 bg-opacity-75 transition-opacity" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="bg-white rounded-lg w-1/2">
        <div class="text-center p-5 flex-auto justify-center">
            <h2 class="text-xl font-bold py-4 ">Estàs segur que vols eliminar l'article?</h3>
